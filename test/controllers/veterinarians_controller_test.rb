...
class VeterinariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinarian" do
    assert_difference("Veterinarian.count") do
      post veterinarians_url, params: { veterinarian: { crm: @veterinarian.crm, name: @veterinarian.name, phone: @veterinarian.phone } }
    end
  ...
  test "should update veterinarian" do
    patch veterinarian_url(@veterinarian), params: { veterinarian: { crm: @veterinarian.crm, name: @veterinarian.name, phone: @veterinarian.phone } }
